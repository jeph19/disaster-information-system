...
function Router({ user, onSignOut }: { user: LocalUser; onSignOut: () => void }) {
  const [location] = useLocation();
  return <ErrorBoundary resetKey={location}><Shell user={user} onSignOut={onSignOut}><Switch><Route path="/" component={Dashboard} /><Route path="/incidents" component={IncidentsPage} /><Route path="/incidents/:id" component={IncidentDetail} /><Route path="/reports" component={ReportsPage} /><Route path="/users">{() => <UsersPage user={user} />}</Route><Route path="/settings" component={SettingsPage} /><Route component={NotFound} /></Switch></Shell></ErrorBoundary>;
}
